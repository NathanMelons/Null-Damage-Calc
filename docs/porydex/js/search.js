...
(function (exports, $) {
	...
	Search.prototype.renderPokemonRow = function (pokemon, matchStart, matchLength, errorMessage, attrs) {
		...
		var formeName = (pokemon.forme || pokemon.name || '').toLowerCase();
		if (formeName.indexOf('gmax') >= 0 || formeName.indexOf('gigantamax') >= 0) return '';
		var id = toID(pokemon.name);
		attrs += ' href="' + (Search.urlRoot || '') + 'pokemon/' + id + '" data-target="push"';
		...
		// icon (same PNGs as calculator /icons)
		buf += '<span class="col iconcol">';
		buf += renderPokedexPokemonListIconHtml(pokemon.name);
		buf += '</span> ';
	...
	Search.prototype.renderTaggedPokemonRowInner = function (pokemon, tag, errorMessage) {
		...
		if (formeName.indexOf('gmax') >= 0 || formeName.indexOf('gigantamax') >= 0) return '';
		var attrs = '';
		attrs = ' href="' + (Search.urlRoot || '') + 'pokemon/' + toID(pokemon.name) + '" data-target="push"';
    ...
    Search.prototype.renderTaggedEncounterRow = function (zone, tag) {
        var attrs = ''
		attrs = ' href="' + (Search.urlRoot || '') + 'encounters/' + toID(zone.name) + '" data-target="replace"';
    ...
    Search.prototype.renderTaggedLocationRowInner = function (pokemon, tag, errorMessage, levelDisplay) {
		var formeName = (pokemon.forme || pokemon.name || '').toLowerCase();
		if (formeName.indexOf('gmax') >= 0 || formeName.indexOf('gigantamax') >= 0) return '';
		var attrs = '';
		attrs = ' href="' + (Search.urlRoot || '') + 'pokemon/' + toID(pokemon.name) + '" data-target="replace"';
		var buf = '<a' + attrs + ' data-entry="pokemon|' + BattleLog.escapeHTML(pokemon.name) + '">';
		...
		// encounter level (location detail only; right of typing)
		if (levelDisplay) {
			buf += '<span class="col enclevelcol">Lv. ' + BattleLog.escapeHTML(levelDisplay) + '</span> ';
		}
	...
	Search.prototype.renderItemRow = function (item, matchStart, matchLength, errorMessage, attrs) {
		...
		attrs += ' href="' + (Search.urlRoot || '') + 'items/' + id + '" data-target="push"';
	...
	Search.prototype.renderAbilityRow = function (ability, matchStart, matchLength, errorMessage, attrs) {
		...
		attrs += ' href="' + (Search.urlRoot || '') + 'abilities/' + id + '" data-target="push"';
    ...
    Search.prototype.renderLocationRow = function (location, matchStart, matchLength, errorMessage, attrs) {
		...
		attrs += ' href="' + (Search.urlRoot || '') + 'encounters/' + id + '" data-target="push"';
        // piggyback off moves
	...
	Search.prototype.renderMoveRow = function (move, matchStart, matchLength, errorMessage, attrs) {
		...
		attrs += ' href="' + (Search.urlRoot || '') + 'moves/' + id + '" data-target="replace"';
	...
	Search.prototype.renderMoveRowInner = function (move, errorMessage) {
		var attrs = '';
		attrs = ' href="' + (Search.urlRoot || '') + 'moves/' + toID(move.name) + '" data-target="replace"';
	...
	Search.prototype.renderTypeRow = function (type, matchStart, matchLength, errorMessage) {
		var attrs = '';
		attrs = ' href="' + (Search.urlRoot || '') + 'types/' + toID(type.name) + '" data-target="push"';
	...
	Search.prototype.renderCategoryRow = function (category, matchStart, matchLength, errorMessage) {
		var attrs = '';
		attrs = ' href="' + (Search.urlRoot || '') + 'categories/' + category.id + '" data-target="push"';
	...
	Search.prototype.renderArticleRow = function (article, matchStart, matchLength, errorMessage) {
		var attrs = '';
		attrs = ' href="' + (Search.urlRoot || '') + 'articles/' + article.id + '" data-target="push"';
	...
	Search.prototype.renderTierRow = function (tier, matchStart, matchLength, errorMessage) {
		var attrs = '';
		attrs = ' href="' + (Search.urlRoot || '') + 'tiers/' + toID(tier.name) + '" data-target="push"';
