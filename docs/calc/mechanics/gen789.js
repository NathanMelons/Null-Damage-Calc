...
function calculateSMSSSV(gen, attacker, defender, move, field) {
    ...
    (0, util_2.checkBerserkGene)(attacker, gen);
    (0, util_2.checkBerserkGene)(defender, gen);
...
function calculateAttackSMSSSV(gen, attacker, defender, move, field, desc, isCritical) {
    ...
    desc.attackEVs =
        move.named('Foul Play')
            ? (0, util_2.getStatDescriptionText)(gen, defender, attackStat, field.defenderSide.isPowerTrick, field.isWonderRoom)
            : (0, util_2.getStatDescriptionText)(gen, attacker, attackStat, field.attackerSide.isPowerTrick, field.isWonderRoom);
