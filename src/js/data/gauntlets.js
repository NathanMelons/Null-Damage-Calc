...
// Use GAUNTLET_LIST (array): duplicate display names are OK. Do NOT use one object with
// repeated keys like { "Gauntlet": [...], "Gauntlet": [...] } — only the last key survives in JS.
// Trainer names are matched flexibly to gen9.js (see trainerNamesMatch).
...
var GAUNTLET_LIST = [
	...
	{ name: "Gauntlet", trainers: ["Tuber Hailey", "Tuber Ricky", "Tuber Lola", "Tuber Sailor Edmond", "Sailor Edmond", "Tuber Chandler", "Sailor MSPaint"] },
	...
	{ name: "Gauntlet", trainers: ["Jagged Pass Team Magma Grunt", "Triathlete Julio"] },
	{ name: "Gauntlet", trainers: ["Psychic Kayla", "Wandering Spirit"] },
...
// Match trainer names flexibly: gauntlets.js names work even when gen9.js uses variants
