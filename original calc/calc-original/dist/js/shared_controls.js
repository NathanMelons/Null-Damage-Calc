...
$(".ability").bind("keyup change", function () {
	...
	var TOGGLE_ABILITIES = ['Protean', 'Flash Fire', 'Intimidate', 'Illuminate', 'Minus', 'Plus', 'Slow Start', 'Unburden', 'Stakeout', 'Teraform Zero'];
...
$(".set-selector").change(function () {
	...
	if ($(this).hasClass('opposing')) {
		...
		for (i in next_poks) {
			...
			var pok = `<img class="trainer-pok right-side" src="${spriteSrc}" data-id="${CURRENT_TRAINER_POKS[i].split("]")[1]}" title="${next_poks[i]}, ${next_poks[i]} BP">`
			trpok_html += pok
		}
	} else {
...
function getSrcImgPokemon(poke) {
	...
	if (poke.name == "Raichu-Mega-X") {
		return `https://i.postimg.cc/brPnbjV5/sprite-00.png`
	}
	if (poke.name == "Raichu-Mega-Y") {
		return `https://i.postimg.cc/ZnmN3hsG/sprite-01.png`
	}
	if (poke.name == "Clefable-Mega") {
		return `https://i.postimg.cc/L5SPfM0F/sprite-02.png`
	}
	if (poke.name == "Victreebel-Mega") {
		return `https://i.postimg.cc/J08XJWdV/sprite-03.png`
	}
	if (poke.name == "Starmie-Mega") {
		return `https://i.postimg.cc/HnmM5CPC/sprite-04.png`
	}
	if (poke.name == "Dragonite-Mega") {
		return `https://i.postimg.cc/8cyC582B/sprite-05.png`
	}
	if (poke.name == "Meganium-Mega") {
		return `https://i.postimg.cc/Wz943RBX/sprite-06.png`
	}
	if (poke.name == "Feraligatr-Mega") {
		return `https://i.postimg.cc/MHsGTkCt/sprite-07.png`
	}
	if (poke.name == "Skarmory-Mega") {
		return `https://i.postimg.cc/L5ysXdcC/sprite-08.png`
	}
	if (poke.name == "Froslass-Mega") {
		return `https://i.postimg.cc/HxvG8pLH/sprite-09.png`
	}
	if (poke.name == "Emboar-Mega") {
		return `https://i.postimg.cc/G2g0Tcph/sprite-10.png`
	}
	if (poke.name == "Excadrill-Mega") {
		return `https://i.postimg.cc/q7pWmtht/sprite-11.png`
	}
	if (poke.name == "Scolipede-Mega") {
		return `https://i.postimg.cc/cJdPDKgQ/sprite-12.png`
	}
	if (poke.name == "Scrafty-Mega") {
		return `https://i.postimg.cc/0N9ht6MY/sprite-13.png`
	}
	if (poke.name == "Eelektross-Mega") {
		return `https://i.postimg.cc/k57LjV6K/sprite-14.png`
	}
	if (poke.name == "Chandelure-Mega") {
		return `https://i.postimg.cc/6QBFH72V/sprite-15.png`
	}
	if (poke.name == "Chesnaught-Mega") {
		return `https://i.postimg.cc/fL9FyY1d/sprite-16.png`
	}
	if (poke.name == "Delphox-Mega") {
		return `https://i.postimg.cc/26ZJyng4/sprite-17.png`
	}
	if (poke.name == "Greninja-Mega") {
		return `https://i.postimg.cc/LX175jGj/sprite-18.png`
	}
	if (poke.name == "Pyroar-Mega") {
		return `https://i.postimg.cc/RFH8hw2K/sprite-19.png`
	}
	if (poke.name == "Floette-Eternal-Mega") {
		return `https://i.postimg.cc/y8GvRkmX/sprite-20.png`
	}
	if (poke.name == "Malamar-Mega") {
		return `https://i.postimg.cc/2St2WVQx/sprite-21.png`
	}
	if (poke.name == "Barbaracle-Mega") {
		return `https://i.postimg.cc/zvhdD5bM/sprite-22.png`
	}
	if (poke.name == "Dragalge-Mega") {
		return `https://i.postimg.cc/8kb4HydH/sprite-23.png`
	}
	if (poke.name == "Hawlucha-Mega") {
		return `https://i.postimg.cc/v8vhzP70/sprite-24.png`
	}
	if (poke.name == "Zygarde-Mega") {
		return `https://i.postimg.cc/jqhcX86c/sprite-25.png`
	}
	if (poke.name == "Drampa-Mega") {
		return `https://i.postimg.cc/gcKsDMyN/sprite-26.png`
	}
	if (poke.name == "Falinks-Mega") {
		return `https://i.postimg.cc/1RKBHW0M/sprite-27.png`
	}
	if (poke.name == "Chimecho-Mega") {
		return `https://i.postimg.cc/1txt8hvg/chimecho.png`
	}
	if (poke.name == "Lucario-Mega-Z") {
		return `https://i.postimg.cc/C5xV1cpJ/lucario.png`
	}
	if (poke.name == "Absol-Mega-Z") {
		return `https://i.postimg.cc/nVNJZYw1/absol.png`
	}
	if (poke.name == "Garchomp-Mega-Z") {
		return `https://i.postimg.cc/zfYvBYtX/garchomp.png`
	}
	if (poke.name == "Heatran-Mega") {
		return `https://i.postimg.cc/MZ3GBQPh/heatran.png`
	}
	if (poke.name == "Darkrai-Mega") {
		return `https://i.postimg.cc/yx17RVcB/darkrai.png`
	}
	if (poke.name == "Golurk-Mega") {
		return `https://i.postimg.cc/0ybXNL6h/golurk.png`
	}
	if (poke.name == "Meowstic-Mega") {
		return `https://i.postimg.cc/7ZftLpCd/meowstic.png`
	}
	if (poke.name == "Crabominable-Mega") {
		return `https://i.postimg.cc/8PynN15D/crabominable.png`
	}
	if (poke.name == "Golisopod-Mega") {
		return `https://i.postimg.cc/x1cpdWk7/golisopod.png`
	}
	if (poke.name == "Magearna-Mega") {
		return `https://i.postimg.cc/cCkMyLc6/magearna.png`
	}
	if (poke.name == "Magearna-Original-Mega") {
		return `https://i.postimg.cc/j23Q0Sh2/magearnao.png`
	}
	if (poke.name == "Zeraora-Mega") {
		return `https://i.postimg.cc/pdP9CtDc/zeraora.png`
	}
	if (poke.name == "Scovillain-Mega") {
		return `https://i.postimg.cc/KjprS851/scovillain.png`
	}
	if (poke.name == "Glimmora-Mega") {
		return `https://i.postimg.cc/prcYbLBT/glimmora.png`
	}
	if (poke.name == "Tatsugiri-Mega") {
		return `https://i.postimg.cc/mrdQFr0q/tatsugiri.png`
	}
	if (poke.name == "Baxcalibur-Mega") {
		return `https://i.postimg.cc/SR985fjZ/baxcalibur.png`
	}
	else if (poke.name == "Aegislash-Shield") {
