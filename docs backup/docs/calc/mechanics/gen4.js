...
function calculateDPP(gen, attacker, defender, move, field) {
    ...
    var isCritical = move.isCrit && !defender.hasAbility('Battle Armor', 'Shell Armor', 'Magma Armor', 'Leaf Guard');
    ...
    desc.defenseEVs =
        (0, util_1.getStatDescriptionText)(gen, defender, defenseStat, field.defenderSide.isPowerTrick, field.isWonderRoom);
