import { Generation, MoveCategory, StatID, StatsTable, TypeName, Weather } from '../data/interface';
...
export declare function checkIlluminate(gen: Generation, source: Pokemon, target: Pokemon): void;
...
export declare function getStatDescriptionText(gen: Generation, pokemon: Pokemon, stat: 'atk' | 'def' | 'spd' | 'spa', powerTrickActive?: boolean, wonderRoomActive?: boolean): string;
