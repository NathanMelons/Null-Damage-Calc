...
export function calculateBWXY(
  ...
  const isCritical =
    move.isCrit && !defender.hasAbility('Battle Armor', 'Shell Armor', 'Magma Armor', 'Leaf Guard') && move.timesUsed === 1;
  ...
  desc.defenseEVs = getStatDescriptionText(gen, defender, defenseStat, field.defenderSide.isPowerTrick, field.isWonderRoom);
